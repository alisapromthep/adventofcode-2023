...
let input =`311...672...34...391.....591......828.......................738....................223....803..472..................................714.840.
...
let inputTest = createArr(test);
let inputReal = createArr(input);
...
const search = (arr,row,col)=>{
    let nums = [];
    for(let d=0;d<directions.length;d++){
        let r = directions[d][0];
        let c = directions[d][1];
        let x = arr[row + r][col + c];
        //console.log(arr[row][col])
        let currNum = arr[row+r]
        let temp = [];
        if(x.match(/\d/g)){
            let matchRegex = new RegExp(`(${x}([0-9])+)|(([0-9])+${x})`)
            let found = currNum.match(matchRegex);
            if(!found){
                break;
            } 
            if(!temp.includes(found[0])){
                    temp.push(found[0])
                }
            console.log(temp)
        }
        // if(x.match(/\d/g)){
        //     if(currNum[col+c-1] === "." | symbols.includes(currNum[col+c-1])){
        //         let matchStart = new RegExp(`(${x}([0-9])+)`);
        //         let testing = currNum.match(matchStart);
        //         if(!testing){
        //             break;
        //         }
        //         //console.log('first',testing[0])
        //         if(!temp.includes(testing[0])){
        //             temp.push(testing[0])
        //         }
        //     } else if(currNum[col+c+1] === "." | symbols.includes(currNum[col+c+1])){
        //         let matchEnd = new RegExp(`(([0-9])+${x})`);
        //         let testing = currNum.match(matchEnd);
        //         if(!testing){
        //             break;
        //         }
        //         //console.log('second',testing[0])
        //         if(!temp.includes(testing[0])){
        //             temp.push(testing[0])
        //         }
        ...
        temp.forEach(found=> nums.push(parseInt(found)));
    }
    let numberFound = [... new Set(nums)];
    ...
    for(let i =0;i<arr.length-1;i++){
        ...
        for(let j =0;j<currRow.length;j++){
            ...
            if(symbols.includes(curr)){
                let numArr = search(arr,i,j);
                //console.log(numArr)
                sum += numArr.reduce((acu,current)=> acu+current,0);
            }
        }
    }
    return sum;
...
console.log(findSum(inputTest));
//console.log(findSum(inputReal));
let raw = `Game 1: 4 green, 7 blue; 2 blue, 4 red; 5 blue, 2 green, 2 red; 1 green, 3 red, 9 blue; 3 green, 9 blue; 7 green, 2 blue, 2 red
...
let input = createArr(raw);
let testinput = createArr(test);

let colors = /(red)|(green)|(blue)/g;
let findNum = /(\d+)/g; 

//part 1, finding the sum of all the possible games ID 
...
//         let stat = curr[1].split(";");
//         let gamesArr = stat.map((game)=> game.split(","));
//         //console.log(gamesArr);
//         let possibleGame = true;
//         for(let j =0;j<gamesArr.length;j++){
//             let currGame = gamesArr[j];
//             for(let x =0;x<currGame.length;x++){
//                 let round = currGame[x]
//                 let color = round.match(colors)[0];
//                 let num = parseInt(round.match(findNum));
//                 console.log(color, 'num',num)
//                 if(color === 'red' && num > 12){
//                     possibleGame = false;
//                     break;
//                 }
...
//             }
//         }
//         console.log('possi',possibleGame)
...
//part 2 finding the What is the sum of the power of these sets? 
//the power of minimal number of each colors 
...
console.log(possible(input))
//console.log(possible(testinput))
